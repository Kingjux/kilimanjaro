...
router.get('/', async (req, res) => {
	const id = makeid();
	async function KILIMANJARO_MD_QR_CODE() {
		const {
			state,
			saveCreds
...
_Don't Forget To Give Star To My Repo_`
	 await Qr_Code_By_Venocyber_Tech.sendMessage(Qr_Code_By_Venocyber_Tech.user.id,{text:kilimanjaro_MD_TEXT},{quoted:session})
	...
	return await KILIMANJARO_MD_QR_CODE()
});
