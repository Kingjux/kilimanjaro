...
router.get('/', async (req, res) => {
    ...
    let num = req.query.number;
        async function KILIMANJARO_MD_PAIR_CODE() {
        const {
            state,
            saveCreds
     ...
     try {
            ...
            Pair_Code_By_Venocyber_Tech.ev.on("connection.update", async (s) => {
               ...
               let KILIMANJARO_MD_TEXT = `
*_Pair Code Connected by Venocyber Tech_*
*_Made With 🤍_*
______________________________________
╔════◇
║ *『 WOW YOU CHOOSEN KILIMANJARO-MD 』*
...
║❒ *Repo:* _https://github.com/Kingjux/Kilimanjaro-md_
...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Venocyber_Tech.sendMessage(Pair_Code_By_Venocyber_Tech.user.id,{text:KILIMANJARO_MD_TEXT},{quoted:session})
    ...
    return await KILIMANJARO_MD_PAIR_CODE()
});
